...
CREATE TABLE company_settings (
    ...
    pending_tva_account           VARCHAR(20) NOT NULL DEFAULT '4438',
    tva_on_collection             BOOLEAN     NOT NULL DEFAULT FALSE,
...
('4438', '4', 'Etat, T.V.A. en attente d''exigibilite (encaissements)', 'credit_normal', '443', TRUE, TRUE),
...
('6011', '6', 'Achats de marchandises dans la Région', 'debit_normal', '601', TRUE, TRUE),
('6012', '6', 'Achats de marchandises hors Région', 'debit_normal', '601', TRUE, TRUE),
('6013', '6', 'Achats de marchandises aux entités du groupe dans la Région', 'debit_normal', '601', TRUE, TRUE),
...
('6021', '6', 'Achats de matieres premieres et fournitures liees dans la Région', 'debit_normal', '602', TRUE, TRUE),
('6022', '6', 'Achats de matieres premieres et fournitures liees hors Région', 'debit_normal', '602', TRUE, TRUE),
('6023', '6', 'Achats de matieres premieres et fournitures liees aux entités du groupe dans la Région', 'debit_normal', '602', TRUE, TRUE),
...
('7011', '7', 'Ventes de marchandises dans la Région', 'credit_normal', '701', TRUE, TRUE),
('7012', '7', 'Ventes de marchandises hors Région', 'credit_normal', '701', TRUE, TRUE),
('7013', '7', 'Ventes de marchandises aux entités du groupe dans la Région', 'credit_normal', '701', TRUE, TRUE),
...
('7021', '7', 'Ventes de produits finis dans la Région', 'credit_normal', '702', TRUE, TRUE),
('7022', '7', 'Ventes de produits finis hors Région', 'credit_normal', '702', TRUE, TRUE),
('7023', '7', 'Ventes de produits finis aux entités du groupe dans la Région', 'credit_normal', '702', TRUE, TRUE),
...
('7031', '7', 'Ventes de produits intermediaires dans la Région', 'credit_normal', '703', TRUE, TRUE),
('7032', '7', 'Ventes de produits intermediaires hors Région', 'credit_normal', '703', TRUE, TRUE),
('7033', '7', 'Ventes de produits intermediaires aux entités du groupe dans la Région', 'credit_normal', '703', TRUE, TRUE),
...
('7041', '7', 'Ventes de produits residuels dans la Région', 'credit_normal', '704', TRUE, TRUE),
('7042', '7', 'Ventes de produits residuels hors Région', 'credit_normal', '704', TRUE, TRUE),
('7043', '7', 'Ventes de produits residuels aux entités du groupe dans la Région', 'credit_normal', '704', TRUE, TRUE),
...
('7051', '7', 'Travaux factures dans la Région', 'credit_normal', '705', TRUE, TRUE),
('7052', '7', 'Travaux factures hors Région', 'credit_normal', '705', TRUE, TRUE),
('7053', '7', 'Travaux factures aux entités du groupe dans la Région', 'credit_normal', '705', TRUE, TRUE),
...
INSERT INTO chart_of_accounts (account_number, account_class, name, account_nature, parent_account_number, is_detail_account, is_system) VALUES
('7061', '7', 'Services vendus dans la Région', 'credit_normal', '706', TRUE, TRUE),
('7062', '7', 'Services vendus hors Région', 'credit_normal', '706', TRUE, TRUE),
('7063', '7', 'Services vendus aux entités du groupe dans la Région', 'credit_normal', '706', TRUE, TRUE),
