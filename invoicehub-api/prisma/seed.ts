...
const ROLES = [
  ...
  },
  {
    ...
    description: 'Ventes, commandes d\'achat et stock, paiements et banque',
    color:       '#2563EB',
    icon:        'briefcase',
    isSystem:    true,
    permissions: [
  ...
  },
  {
    ...
    description: 'Gestion complète des ventes et des achats, comptabilité, banque, dépenses et exports',
    color:       '#9333EA',
    icon:        'calculator',
    isSystem:    true,
    permissions: [
      'invoices:read', 'invoices:create', 'invoices:update', 'invoices:cancel', 'invoices:delete',
      'proformas:read', 'proformas:create', 'proformas:update', 'proformas:delete',
      'clients:read', 'clients:create', 'clients:update', 'clients:delete',
      'products:read',
      'payments:read', 'payments:create', 'payments:delete',
      'suppliers:read', 'suppliers:write', 'suppliers:delete',
      'purchase-orders:read', 'purchase-orders:write', 'purchase-orders:delete',
      'supplier-invoices:read', 'supplier-invoices:write', 'supplier-invoices:validate', 'supplier-invoices:pay', 'supplier-invoices:delete',
      'stock:read', 'stock:adjust',
      'expenses:read', 'expenses:create', 'expenses:update', 'expenses:approve', 'expenses:pay', 'expenses:delete',
      'bank:read', 'bank:import-parse', 'bank:import-confirm', 'bank:reconcile',
