...
const EMAIL_TEMPLATES: {
  ...
  },
  {
    ...
    variables: ['{{clientName}}', '{{invoiceNumber}}', '{{totalTtc}}', '{{companyName}}'],
  },
  {
    type:     'invoice_partially_paid',
    name:     'Paiement partiel reçu',
    subject:  '[{{companyName}}] Paiement partiel reçu — {{invoiceNumber}}',
    bodyHtml: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;color:#1f2937;">\n  <div style="background:#2D7DD2;padding:20px 28px;border-radius:8px 8px 0 0;">\n    <h2 style="color:#fff;margin:0;font-size:18px;">Paiement partiel reçu</h2>\n  </div>\n  <div style="border:1px solid #e5e7eb;border-top:none;padding:28px;border-radius:0 0 8px 8px;">\n    <p>Bonjour {{clientName}},</p>\n    <p>Nous avons bien reçu votre paiement de <strong>{{amountPaid}} XAF</strong> pour la facture <strong>{{invoiceNumber}}</strong>. Il reste un solde de <strong>{{balanceDue}} XAF</strong> à régler.</p>\n    <table style="width:100%;border-collapse:collapse;margin:20px 0;">\n      <tr style="background:#f9fafb;"><td style="padding:10px 16px;border:1px solid #e5e7eb;font-weight:bold;">Montant reçu</td><td style="padding:10px 16px;border:1px solid #e5e7eb;color:#2D7DD2;font-weight:bold;">{{amountPaid}} XAF</td></tr>\n      <tr><td style="padding:10px 16px;border:1px solid #e5e7eb;font-weight:bold;">Solde restant</td><td style="padding:10px 16px;border:1px solid #e5e7eb;font-weight:bold;color:#dc2626;">{{balanceDue}} XAF</td></tr>\n    </table>\n    <p style="margin-top:24px;">Cordialement,<br><strong>{{companyName}}</strong></p>\n  </div>\n</div>`,
    variables: ['{{clientName}}', '{{invoiceNumber}}', '{{amountPaid}}', '{{balanceDue}}', '{{totalTtc}}', '{{companyName}}'],
  },
  {
    type:     'proforma_accepted',
    name:     'Proforma acceptée',
    ...
    variables: ['{{clientName}}', '{{proformaNumber}}', '{{totalTtc}}', '{{companyName}}'],
  },
  {
    type:     'proforma_rejected',
    name:     'Proforma rejetée',
    ...
    variables: ['{{clientName}}', '{{proformaNumber}}', '{{comment}}', '{{companyName}}'],
  },
  {
    type:     'proforma_expired',
    name:     'Proforma expirée',
    ...
    variables: ['{{clientName}}', '{{proformaNumber}}', '{{validUntil}}', '{{companyName}}'],
  },
  {
